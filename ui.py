...
class Ui ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.start_all_service = wx.Button( self.basic_panel, wx.ID_ANY, u"start", wx.DefaultPosition, wx.Size( 120,70 ), 0, wx.DefaultValidator, u"start" )
		services_sizer.Add( self.start_all_service, 0, wx.ALL, 5 )
		
		self.stop_all_service = wx.Button( self.basic_panel, wx.ID_ANY, u"stop", wx.DefaultPosition, wx.Size( 120,70 ), 0, wx.DefaultValidator, u"stop" )
		...
		self.advt_setting = wx.Button( self.basic_panel, wx.ID_ANY, u"advt setting", wx.DefaultPosition, wx.DefaultSize, 0, wx.DefaultValidator, u"advt" )
		...
		self.basic_setting = wx.Button( self.advt_panel, wx.ID_ANY, u"basic setting", wx.DefaultPosition, wx.DefaultSize, 0, wx.DefaultValidator, u"basic" )
